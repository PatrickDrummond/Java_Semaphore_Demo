...
public class Server extends Thread {
     ...
     * @param trans
     */
     public boolean processTransactions(Transactions trans) throws InterruptedException {   int accIndex;             	/* Index position of account to update */
...
//        		 }
         ...
         //System.out.println("ABOVE SERVER RETURN");
         return true;
     }
