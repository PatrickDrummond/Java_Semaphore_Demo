...
public class Network extends Thread {
    ...
    static Semaphore empty1 = new Semaphore(1);
    static Semaphore mutex1 = new Semaphore(1);

    static Semaphore full2 = new Semaphore(0);
    static Semaphore empty2 = new Semaphore(1);
...
//            System.out.println("EMPTY1 SEM STATUS:" + empty1);
//            System.out.println("MUTEX1 SEM STATUS:" + mutex1);
            ...
            inComingPacket[inputIndexClient].setAccountNumber(inPacket.getAccountNumber());
        		 ...
        		 //System.out.println("\n DEBUG : Network.send() - account number " + inComingPacket[inputIndexClient].getAccountNumber());
        		  ...
        		  {
                      //System.out.println("IN BUFFER SET TO NORMAL");
           ...
           // System.out.println("available permits full1" + full1.availablePermits());
     ...
     */
       public static boolean transferIn(Transactions inPacket) throws InterruptedException {
            ...
            // Semaphore Lock
           //System.out.println("INSIDE TRANSFER IN");
           full1.acquire(1);
           mutex1.acquire(1);
    ...
    {	
    	...
    	while (true)
    	{
            ...
            if (getClientConnectionStatus().equals("disconnected") && (getServerConnectionStatus().equals("disconnected"))){
                    Network.setNetworkStatus("disconnected");
